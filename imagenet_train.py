...
parser.add_argument('--data', metavar='DIR', default="/ceph/tensorflow_module_ai/kwin/caltech101/",
...
parser.add_argument('--pretrained', default='None', help='use pre-trained model')
